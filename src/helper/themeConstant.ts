...
import { checkboxIcon, checkedIcon } from '../assets/icons/Icons';
    ...
    MuiOutlinedInput: {
        styleOverrides: {
            root: {
                ...
                backgroundColor: lightModePalette.grey[50],
                borderRadius: '8px',
                ...
                '&.Mui-error': {
                    ...
                    [`&.Mui-focused .${outlinedInputClasses.notchedOutline}`]: {
                        borderColor: lightModePalette.error.main,
                    },
                },
            },
            input: {
            ...
            colorWarning: {
                [`&.Mui-focused .${outlinedInputClasses.notchedOutline}`]: {
                    borderColor: lightModePalette.warning.main,
                },
            },
            colorInfo: {
                [`&.Mui-focused .${outlinedInputClasses.notchedOutline}`]: {
                    borderColor: lightModePalette.info.main,
                },
            },
            colorSuccess: {
                [`&.Mui-focused .${outlinedInputClasses.notchedOutline}`]: {
                    borderColor: lightModePalette.success.main,
                },
            },
            notchedOutline: {
                top: 0,
